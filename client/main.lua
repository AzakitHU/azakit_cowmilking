...
function InteractMilking(index)
        ...
        Interact = true
            ...
            lib.requestAnimDict('amb@world_human_gardener_plant@male@idle_a', 10)
			TaskPlayAnim(PlayerPedId(), 'amb@world_human_gardener_plant@male@idle_a', 'idle_a', 8.0, -8.0, -1, 48, 0)
